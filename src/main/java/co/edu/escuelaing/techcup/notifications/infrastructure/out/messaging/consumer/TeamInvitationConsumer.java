...
import co.edu.escuelaing.techcup.notifications.infrastructure.out.messaging.dto.TeamInvitationMessageV1;
...
public class TeamInvitationConsumer {

    private final TeamLinkEventListener teamLinkEventListener;

    @RabbitListener(queues = RabbitMqConfig.QUEUE_EQUIPOS_INVITACIONES)
    public void onMessage(TeamInvitationMessageV1 message) {
        teamLinkEventListener.onTeamInvited(message.toDomain());
    }
}
