...
import co.edu.escuelaing.techcup.notifications.infrastructure.out.messaging.dto.TeamLinkRequestedMessageV1;
...
public class TeamLinkRequestedConsumer {

    private final TeamLinkEventListener teamLinkEventListener;

    @RabbitListener(queues = RabbitMqConfig.QUEUE_EQUIPOS_SOLICITUDES)
    public void onMessage(TeamLinkRequestedMessageV1 message) {
        teamLinkEventListener.onLinkRequested(message.toDomain());
    }
}
